...
from multirotor_model import export_multirotor_ode_model
import numpy as np
import scipy.linalg
import os
...
#set model
model = export_multirotor_ode_model()
ocp.model = model
...
ocp.cost.yref = np.array(
    ...
    hover_prop, hover_prop, hover_prop, hover_prop, 1.0,1.0,1.0,1.0])
...
ocp.code_export_directory = dir_path + "/multirotor_ode"
...
#
#plot_multirotor(np.linspace(0, Tf, N + 1), thrust_max, simU, simX, latexify = False)
